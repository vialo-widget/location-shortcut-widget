package com.navigo.app.service.deeplink
...
/**
 * Decodes a `navigo://add?…` URI (or any URI carrying `label`/`lat`/`lng`
 * params, as a fallback) into a [PendingShortcut].
 *
 * The activity normalises HTTPS app-link URIs into the custom scheme before
 * publishing on the bus — see [com.navigo.app.MainActivity.handleIntent].
 *
