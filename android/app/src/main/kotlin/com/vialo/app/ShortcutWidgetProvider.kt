...
/**
 * Vialo home-screen widget — a flowing grid of fixed 1×1-icon tiles.
 *
...
class ShortcutWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
         ...
         *  80dp + 2dp margins gives a pitch of 84dp, room for a 48dp icon
         *  plus the label, and matches a typical 5-column launcher row
         *  on modern phones so column count tracks the launcher's. */
        private const val SLOT_DP = 80
