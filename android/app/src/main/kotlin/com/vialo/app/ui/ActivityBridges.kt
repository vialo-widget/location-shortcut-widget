 ...
 *
 * Provided by [VialoApp] and consumed where needed (e.g. Settings screen),
 * so the UI layer doesn't have to know about [com.vialo.app.MainActivity].
 */
...
val LocalActivityBridges = staticCompositionLocalOf<ActivityBridges> {
    error("LocalActivityBridges not provided — wrap content in VialoApp { … }.")
}
